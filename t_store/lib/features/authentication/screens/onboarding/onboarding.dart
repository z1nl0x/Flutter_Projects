...
import 'package:t_store/features/authentication/screens/onboarding/widgets/onboard_dot_navigation.dart';
...
class OnBoardingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Páginas scrollaveis horizontalmente
          PageView(
          ...
          // Botão de pular página
          OnBoardingSkip(),

          // Navegador por pontos SmoothPageIndicator
